// Author: https://github.com/banned-from-everywhere
...
var GameLayer = cc.Layer.extend({
  ...
  init: function () {
    ...
    backMenu.onClick(function () {
      window.location.href = "https://github.com/banned-from-everywhere";
    });
    ...
    var action = cc.Spawn.create(
      ...
      cc.JumpTo.create(1.5, this.birdStartPos, 100, 1)
    );
